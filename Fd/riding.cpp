...
void startRiding(int id) {
    ...
    if (isRidingToObject(charac) == 2) {
        sengGameNoticeMsg_95D130((*(int***)0x1A6F750)[0x10], (int)L"��״̬���޷�������", 0xFF9BC8E6, 0x10, 0, 0, 0);
        return;
    }
    //if(isRidingToObject)
    ...
    sq_WriteBool_67E850(charac, 1);//�ٻ�����
    sq_WriteDword_67E870(charac, ridableSpinner.ridableId[id]);//id
    sq_WriteWord_BB2B50(charac, 0);//��Ӫ 0/�ѷ� 100/���� 200/����
...
void ridingInitDelay(int* thisP) {
    ...
    int x = 614, y = 356;
    //ridableSpinner�ȳ�ʼ������ʾ���ȼ���ridableBtn��
...
bool __fastcall fixRidableQuestLabelDetailSubWinImp(int* thisP) {
    ...
    drawText_1211C30(*(int**)0x1B5582C, x, y, 0xFF93C5DD, (int)L"������½�����");
...
void ridingInit(void) {
    ...
    *(DWORD*)0x004C92B9 = 489 * 0.8f + 5;//y
    ...
    writeJmpCode((void*)0x00B37D48, �����ٻ����ﶯ��);
